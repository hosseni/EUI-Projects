...
#define SCB_CLOCK_GATE_UART1         60u
#define SCB_CLOCK_GATE_UART2         61u
#define SCB_CLOCK_GATE_UART3         62u
#define SCB_CLOCK_GATE_UART4         63u
#define SCB_CLOCK_GATE_UART5         64u
#define SCB_CLOCK_GATE_UART6         65u
#define SCB_CLOCK_GATE_UART7         66u
#define SCB_CLOCK_GATE_UART8         67u
...
//      SCB_CLOCK_GATE_TIMER3     ,
//      SCB_CLOCK_GATE_TIMER4     ,
//      SCB_CLOCK_GATE_TIMER5     ,

      SCB_CLOCK_GATE_GPIOA      ,
      SCB_CLOCK_GATE_GPIOB      ,
      SCB_CLOCK_GATE_GPIOC      ,
...
const SCB_ConfigType SCBConfig[SCB_CLOCK_SETTINGS_SIZE]=
{
    ...
    /* 0            */ {  SCB_CLOCK_SOURCE_MOSC             ,DISABLE     ,16000},
